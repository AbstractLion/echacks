...
$sql_connection->query("create table if not exists pacts (id integer primary key auto_increment, group_uuid text, user_uuid_array text, leader_uuid text, group_name text, password text)");
